...
Convert Claude Code, Cursor, Codex, Gemini CLI, OpenCode, and Grok Build session transcripts into embeddable HTML replays.
...
function buildReplay() {
  ...
  const html = render(turns, {
    ...
    assistantLabel: values["assistant-label"] || (format === "gemini" ? "Gemini" : format === "codex" ? "Codex" : format === "cursor" ? "Assistant" : format === "opencode" ? "OpenCode" : format === "grok" ? "Grok" : "Claude"),
    title,
